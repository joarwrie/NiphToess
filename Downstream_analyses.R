...
adonis2(tab_hellinger~Month+Landuse+Aquifer, data=tab_env, permutations=9999, method="euclidean", by="terms")
adonis2(tab_hellinger~Month+Aquifer+Landuse, data=tab_env, permutations=9999, method="euclidean", by="terms")
